...
public interface IUserRepository {
    ...
    @NonNull
    Optional<UserDbo> create(@NonNull Username username, @NonNull Email email, @NonNull String passwordHash);
    ...
    void update(@NonNull UserId id, @NonNull Optional<Username> username, @NonNull Optional<Email> email);
