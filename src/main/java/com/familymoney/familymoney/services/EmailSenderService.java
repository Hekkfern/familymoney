...
public class EmailSenderService implements IEmailSenderService {
    ...
    @Override
    public void sendEmailVerificationEmail(@NonNull Email toEmail, @NonNull Username username,
        ...
        try {
            mimeMessageHelper.setFrom(
                    String.format("%s <%s>", mailSenderProperties.getName(), mailSenderProperties.getEmail()));
    ...
    @Override
    public void sendPasswordResetEmail(@NonNull Email toEmail, @NonNull Username username,
