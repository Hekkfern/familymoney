...
public interface IEmailSenderService {
    ...
    void sendEmailVerificationEmail(@NonNull Email toEmail, @NonNull Username username,
            @NonNull EmailVerificationToken verificationToken);

    void sendPasswordResetEmail(@NonNull Email toEmail, @NonNull Username username,
